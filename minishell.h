...
/*   Updated: 2023/07/28 15:48:28 by bsirikam         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// env
int			init_environ(char **env, t_data *g_data);
int			end_environ(t_data *g_data);
char		*my_getenv(char *str, t_data *g_data);

// parser_1 - main split + split long list to cmd
t_cmdlist	*str_split(char *str, t_data *g_data);
...
t_strcut	*remove_q_xpand(t_strcut *head, t_data *g_data);

// parser_5 - expand
void		expand_var(t_strcut *tmp, t_data *g_data);
...
int			to_openheredoc(t_strcut *cmd, t_heredoc *hd, t_data *g_data);
